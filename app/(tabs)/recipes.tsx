  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        {isSearchActive ? (
          <View style={styles.searchBarContainer}>
            ...
            <TextInput
              ...
              // MODIFICATION ICI : Ferme la barre quand on valide au clavier
        ...
        {!isSearchActive && (
           <Text style={styles.headerSub}>Basées sur tes ingrédients disponibles</Text>
        )}
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={{alignItems: 'center', marginTop: 50}}>
            <Text style={{color: '#888'}}>Aucune recette trouvée pour "{searchQuery}" 😕</Text>
          </View>
        }
        ListHeaderComponent={() => (
...
const styles = StyleSheet.create({
  ...
  header: { 
    backgroundColor: '#00C853', paddingHorizontal: 20, paddingTop: 60, paddingBottom: 20,
    borderBottomLeftRadius: 20, borderBottomRightRadius: 20, justifyContent: 'flex-end', minHeight: 110
  },
  ...
  searchBarContainer: {
    flexDirection: 'row', backgroundColor: '#FFF', borderRadius: 10, paddingHorizontal: 15, paddingVertical: 8,
  ...
  card: { backgroundColor: '#FFF', borderRadius: 15, marginBottom: 15, overflow: 'hidden', elevation: 3, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 5 },
  cardImage: { width: '100%', height: 180 },
  cardContent: { padding: 15 },
  cardTitle: { fontSize: 18, fontWeight: 'bold', color: '#333', flex: 1 },
  rowBetween: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  ratingBadge: { flexDirection: 'row', backgroundColor: '#FFC107', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 5, alignItems: 'center' },
