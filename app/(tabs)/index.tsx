...
const TRENDING_RECIPES = [
  ...
  },
  {
    ...
    price: "3.80€",
    image: {
      uri: "https://www.themealdb.com/images/media/meals/1529444113.jpg",
    },
  },
  {
    id: "3",
    ...
    price: "1.90€",
    image: {
      uri: "https://www.themealdb.com/images/media/meals/1529446137.jpg",
    },
  },
];
      ...
      >
        ...
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.greetingSub}>
            Prêt à cuisiner quelque chose de délicieux ?
          </Text>
        </View>
        ...
        <View style={styles.actionsContainer}>
          ...
          <Link href="/(tabs)/fridge" asChild>
            <TouchableOpacity style={styles.actionCard}>
              ...
              <Text style={styles.actionDesc}>
                Gère ton inventaire et génère des recettes
              </Text>
            </TouchableOpacity>
          </Link>
          ...
          <Link href="/(tabs)/recipes" asChild>
            <TouchableOpacity style={styles.actionCard}>
              ...
              <Text style={styles.actionDesc}>
                Découvre des recettes adaptées à ton budget
              </Text>
            </TouchableOpacity>
          </Link>
        </View>
