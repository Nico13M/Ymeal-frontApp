...
function getRegisterErrorMessage(error: unknown): string {
  ...
  const fallback = getHumanErrorMessage(
    error,
            ...
            {password.length > 0 && (
              <View style={styles.passwordRules}>
                <Text
                  style={[
                    styles.rule,
                    passwordRules.minLength && styles.ruleOk,
                  ]}
                >
                ...
                <Text
                  style={[
                    styles.rule,
                    passwordRules.hasUpperCase && styles.ruleOk,
                  ]}
                >
                ...
                <Text
                  style={[
                    styles.rule,
                    passwordRules.hasNumber && styles.ruleOk,
                  ]}
                >
                ...
                <Text
                  style={[
                    styles.rule,
                    passwordRules.hasSpecialChar && styles.ruleOk,
                  ]}
                >
                  {passwordRules.hasSpecialChar ? "✓" : "✗"} Un caractère
                  spécial
                </Text>
              </View>
            )}
